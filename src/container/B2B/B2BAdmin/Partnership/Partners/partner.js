...
function PartnerList() {
  ...
  const redirectUrl = userData?.slug ? `/partners/add-partner` : '/partners/add-partner';
  ...
  const handlePagination = (pageNumber, pageSize, searchKey, query, sortBy, sortOrder) => {
    setLoader(true);
    Api.getPartners(pageNumber, pageSize, searchKey, query, sortBy, sortOrder).then((response) => {
