...
const pages = [{ name: 'Push Notifications', href: '/push-notification', current: true }];
...
function PushNotification() {
  ...
  const handlePagination = (pageNumber, pageSize, searchKey) => {
    setLoader(true);
    Api.getAllNotifications(1, pageNumber, pageSize, searchKey).then((response) => {
          ...
          <div className="mt-3 flex justify-between items-center">
            ...
            <div className="flex ">
              <div className="ml-3 self-center">
                <button
                  onClick={() => navigate('/push-notification/add')}
                  type="button"
